 ...
 * @author principalpc
 */
public class DropUniquesAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        List<Row> listaRowsEliminarUniques = new ArrayList<Row>();
        for (int i = 0; i < lista.size(); i++) {
            ...
            while (it.hasNext() && !bEncontrado) {
                ...
                if (r.getIdGo().equals(lista.get(i))) {
                    listaRowsEliminarUniques.add(r);
                    bEncontrado = true;
                }
            }
        }
        ...
        set.removeAll(listaRowsEliminarUniques);
