 ...
 * @author principalpc
 */
public class DownloadStopwordsCreateAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        PrintWriter pw = null;
        try {
            fichero = new FileWriter(pathSesion + File.separator + "stopwords.txt");
        ...
        try {
            ...
            FileInputStream in = new FileInputStream(new File(pathSesion + File.separator + "stopwords.txt"));
