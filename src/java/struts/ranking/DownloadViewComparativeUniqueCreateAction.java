 ...
 * @author principalpc
 */
public class DownloadViewComparativeUniqueCreateAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        DownloadViewComparativeUniqueCreateActionForm applyForm = (DownloadViewComparativeUniqueCreateActionForm) form;
        ...
        PrintWriter pw = null;
        try {
            fichero = new FileWriter(filePath + File.separator + "uniques.txt");
        ...
        try {
            ...
            FileInputStream in = new FileInputStream(new File(filePath + File.separator + "uniques.txt"));
